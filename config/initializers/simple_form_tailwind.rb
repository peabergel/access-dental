...
SimpleForm.setup do |config|
  ...
  config.button_class = "my-2 cursor-pointer bg-access-blue hover:bg-access-dark text-white font-bold text-sm py-2 px-4 rounded"
  ...
  config.wrappers :vertical_form, tag: "div", class: "mb-4" do |b|
    ...
    b.use :input, class: "shadow appearance-none border border-gray-300 rounded w-full py-2 px-3 bg-white focus:outline-none focus:ring-0 focus:border-blue-500 text-gray-500 leading-6 transition-colors duration-200 ease-in-out", error_class: "border-red-500", valid_class: "border-green-400"
